...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="dbcxreg.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<indexFile>DBCXREG.CDX</indexFile>

	<INDEXES>
		<INDEX>
			<TagName>CPRODNAME</TagName>
			<TagType>CANDIDATE</TagType>
			<Key>UPPER(CPRODNAME)</Key>
			<Filter></Filter>
